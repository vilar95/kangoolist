...
showAddEditKangooListModal({
  ...
  // Controlador do campo que receberá o nome do KangooList 
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      KangooList kangooList = KangooList(
                      ...
                      if (model == null) {
                       appDatabase.insertKangooList(kangooList);
                      } else {
                        
                        kangooList.id = model.id;
                        appDatabase.updateKangooList(kangooList);
                      }
